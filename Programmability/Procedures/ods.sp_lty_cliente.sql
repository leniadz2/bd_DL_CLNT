...
TRUNCATE TABLE ods.LYTY_CLI_tmp0

INSERT INTO ods.LYTY_CLI_tmp0
  (CODIGOPERSONA,
   NRODOCUMENTO,
   DNI_Valido,
   NOMBRES,
...
SELECT *
  FROM ods.LYTY_CLI_tmp3;

INSERT INTO ods.LYTY_CLI_tmp4
SELECT *
  FROM ods.LYTY_CLI_tmp0
 WHERE NRODOCUMENTO NOT IN (SELECT NRODOCUMENTO FROM ods.LYTY_CLI_tmp3);
